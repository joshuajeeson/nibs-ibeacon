...
INSERT INTO salesforce.campaign (id, name, description, image__c, type, status) VALUES
    (1, '£20 Off Power Gym membership', 'Get £20.00 off of the Power Gym membership when you take up.', 'https://s3-eu-west-1.amazonaws.com/joshdaniel/hTsZGYvu.jpg', 'Offer', 'In Progress'),
    (2, '10% of Ski-Trip', 'Twice as much Fun! Now enjoy a ski-trip at 10% off on the full price at Gadventures', 'https://s3-eu-west-1.amazonaws.com/joshdaniel/skiiing-workout.jpg', 'Offer', 'In Progress'),
